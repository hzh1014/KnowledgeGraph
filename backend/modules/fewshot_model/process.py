...
relation_ie = Taskflow("information_extraction", schema=schema_v4.schema, task_path="/data_F/zhijian/fuchuang-kg/PaddleNLP-model_zoo-uie/checkpoint/model_best_41line_100ep")
